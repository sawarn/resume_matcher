...
job_description_data = pd.read_csv('/Users/sawarn/Downloads/resume_matcher/abc.csv')
...
# Tokenize and convert text to embeddings for CVs and job descriptions
cv_embeddings = []
job_description_embeddings = []

for index, row in cv_data.iterrows():
    # Convert 'Education' and 'Skills' columns to strings and concatenate them
...
matching_results = pd.DataFrame.from_dict(matches, orient='index')
